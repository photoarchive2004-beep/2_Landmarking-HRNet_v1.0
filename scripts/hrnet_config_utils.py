...
def load_hrnet_config() -> Dict[str, Any]:
    ...
    augment.setdefault("flip_augmentation", False)
    augment.setdefault("rotation_augmentation_deg", 0)
    augment.setdefault("rotation_augmentation_prob", 0.0)
    augment.setdefault("scale_augmentation", 0.0)
    augment.setdefault("scale_augmentation_prob", 0.0)
    color_jitter = augment.setdefault("color_jitter", {})
    color_jitter.setdefault("enabled", False)
    color_jitter.setdefault("prob", 0.0)
